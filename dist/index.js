...
var DANFe = async (data = {}) => {
  ...
  var PDF = {
    ...
    mtBlock: 0,
    barCode: null
  }, isBrowser = typeof window !== "undefined", xml = parser.parse(data.xml || ""), consulta = typeof data.consulta != "undefined" ? parser.parse(data.consulta) : {}, logo = data.logo, imgDemo = data.imgDemo;
